...
export const Footer = () => {
  return (
    <footer className="bg-amareloPrimaria text-white py-8 px-4 md:px-8 mt-auto">
      <div className="container mx-auto flex flex-col md:flex-row justify-between items-center">
        <div className="text-center md:text-left">
          <h2 className="text-2xl font-bold mb-2">Contato</h2>
          <p className="text-white mb-2">Avenida Patrice Lumumba, n° 1566</p>
          <p className="text-white mb-2">Cidade de Maputo</p>
        </div>
